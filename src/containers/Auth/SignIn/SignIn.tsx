...
const SignIn: FC<any> = () => {
  ...
  const onSignUp = () => {
    if (!form.login) {
      dispatch(messageQueueAction.addMessage(null, "error", "Введите логин"));
      return;
    }
    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.title}>
          <img src={logoHigh} alt="Логотип" />
          <p className={styles.titleH}>Добро пожаловать</p>
          <text className={styles.titleT}>
            Войдите в дневник, используя
            <br /> данные <a href="https://edu.tatar.ru">edu.tatar.ru</a>
          </text>
        </div>
        <form
